	...
	<view class="center">
		...
		<view class="userInfo" @click.capture="toUserInfo">
			...
			<view
				...
				class="pic"
				style="overflow: hidden; width: 150rpx; height: 150rpx; border-radius: 50%; overflow: hidden"
			>
				<cloud-image width="100%" height="100%" v-if="hasLogin && userInfo.avatar_file && userInfo.avatar_file.url" :src="userInfo.avatar_file.url"></cloud-image>
			</view>
